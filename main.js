...
//toplam state'i oluşturma  (durum)
let toplam = 0;
...
function addExpense(e) {
  ...
  //eğer checkboxtiklendiyse bir class daha eklendi
  ...
  harcamaDiv.innerHTML = ` 
   ...
   <div class="buttons">
     <img id="payment" src="./images/icons8-card-payment-50.png">
     <img id="remove" src="./images/icons8-delete-100.png">
   </div>
   `;
...
// listey tıklanma olayını yönetme

function handleClick(e) {
  const element = e.target;
  if (element.id === "remove") {
    //tıklanılanm sil butonunun kapsayıcısını alma
    const wrapperElement = element.parentElement.parentElement;

    //silinen harcamanın fiyatını alma
